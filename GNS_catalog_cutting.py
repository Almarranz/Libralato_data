...
if choosen_cluster =='arches':
    ...
    m_arc = SkyCoord(['17h46m14.68579s'], ['-28d49m38.99169s'], equinox = 'J2000')

idxc, around_arc, d2d,d3d =  ap_coor.search_around_sky(m_arc, gns_coord, 80*u.arcsec)
gns_ar = gns[around_arc]
np.savetxt(cata +'GNS_%s.txt'%(choosen_cluster), gns_ar, fmt = '%.8f', header = '_RAJ2000 _DEJ2000 RAJ2000 e_RAJ2000 DEJ2000 e_DEJ2000 RAJdeg e_RAJdeg DEJdeg e_DEJdeg RAHdeg e_RAHdeg DEHdeg e_DEHdeg RAKsdeg e_RAKsdeg DEKsdeg e_DEKsdeg mag e_Jmag Hmag e_Hmag Ksmag e_Ksmag iJ iH iKs')
